...
class LivenessDetectionBloc
          ...
          startDetection: (_) async {
            _controller?.startImageStream(
              (image) async {
                ...
                if (faces != null) {
                  Utils.liveness_detectionPrint('Обнаружено лиц: ${faces.length}');
  ...
  Future<Uint8List?> _captureFinalImage() async {
    try {
      ...
      Utils.liveness_detectionPrint('Ошибка при захвате финального изображения: $e');
      return null;
    }
  }
